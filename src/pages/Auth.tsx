...
const phoneSchema = z.string().refine(val => val.toLowerCase() === "admin" || /^[6-9]\d{9}$/.test(val), "Enter a valid 10-digit number or Admin ID");
const OTP_CODE = "1234";
...
const Auth = () => {
  ...
  const handlePasswordSubmit = async () => {
    ...
    try {
      ...
      toast({ title: "Admin Access Granted", description: "Logged in successfully" });
    } catch (err: any) {
            ...
            {step === "phone" ? (
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <Button variant="outline" className="w-full gap-2 h-12" onClick={handleGoogleLogin} disabled={submitting}>
              ...
              <motion.div
                ...
                className="space-y-6"
              >
                <button onClick={() => { setStep("phone"); setPassword(""); }} className="flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground transition-colors">
